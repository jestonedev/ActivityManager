...
namespace BLL.Declension
{
    ...
    /// </remarks>
    internal static class DeclensionBLL
    {
        ...
        [DllImport("Padeg.dll", EntryPoint = "GetFIOPadeg")]
        ...
        [DllImport("Padeg.dll", EntryPoint = "GetFIOParts")]
        private static extern Int32 decGetFIOParts(IntPtr surnameNamePatronimic, ref FIOParts result);

        [DllImport("Padeg.dll", EntryPoint = "UpdateExceptions")]
        private static extern Int32 decUpdateExceptions();

        [DllImport("Padeg.dll", EntryPoint = "GetExceptionsFileName")]
        ...
        [DllImport("Padeg.dll", EntryPoint = "SetDictionary")]
        ...
        private struct FIOParts
        {
            ...
            {
                pSurname = Marshal.AllocHGlobal(maxResultStringBufSize);
                pName = Marshal.AllocHGlobal(maxResultStringBufSize);
                pPatronimic = Marshal.AllocHGlobal(maxResultStringBufSize);

                lenSurname = lenName = lenPatronimic = maxResultStringBufSize;
            }
    ...
    public class DeclensionException : Exception, ISerializable
    {
        ...
        /// <summary>
        /// Конструктор исключения модуля перевода падежа
        /// </summary>
        ...
        /// </summary>
        /// <param name="message">Сообщение об ошибке</param>
        /// <param name="innerException">Вложеное исключение</param>
