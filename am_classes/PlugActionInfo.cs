...
namespace AMClasses
{
	public class PlugActionInfo
	{
		...
		public PlugActionInfo(MethodInfo mi, ParameterInfo[] pis)
		{
			method_info = mi;
			ActionName = mi.Name;
		...
		public void Execute(object instance, object[] inputParameters, out object[] outputParameters)
		{
			...
			method_info.Invoke(instance, exec_parameters);
