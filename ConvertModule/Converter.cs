...
namespace ConvertModule
{
    ...
    public class Converter
    {
        ...
        List<string> ordinals_ones = new List<string>() { "", "первый", "второй", "третий", "четвёртый", "пятый", 
        ...
        List<string> ordinal_hundreds = new List<string>() { "", "сотый", "двухсотый", "трёхсотый", "четырёхсотый", 
        ...
        List<string> ordinals_part_ones_prefix = new List<string>() { "", "одно", "двух", "трёх", "четырёх", "пяти", 
        ...
        List<string> ordinals_part_hundreds_prefix = new List<string>() { "", "сто", "двухсот", "трёхсот", "четырёхсот", 
